...
import io.agora.rtc2.video.IVideoFrameObserver.PROCESS_MODE_READ_ONLY
import io.agora.rtc2.video.IVideoFrameObserver.PROCESS_MODE_READ_WRITE
import io.agora.rtc2.video.IVideoFrameObserver.VIDEO_PIXEL_DEFAULT
    ...
    init {
        ...
        rtcEngine!!.registerVideoFrameObserver(object : IVideoFrameObserver {
            override fun onCaptureVideoFrame(sourceType: Int, videoFrame: VideoFrame?): Boolean {
                ...
                Log.e("", "videoFrame.format I420Buffer: ${videoFrame?.buffer is I420Buffer}, TextureBuffer: ${videoFrame?.buffer is TextureBuffer}")
//                videoFrame?.apply {
