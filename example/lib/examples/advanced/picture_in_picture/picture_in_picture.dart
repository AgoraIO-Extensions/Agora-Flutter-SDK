...
class _State extends State<PictureInPicture> with WidgetsBindingObserver {
  ...
  Future<void> _dispose() async {
    ...
    await _pipController.unregisterPipStateChangedObserver();
  ...
  Future<void> _setupPip() async {
    ...
    // need this to specify the stream is in which channel
    RtcConnection currentConnection = RtcConnection(
    ...
    AgoraPipOptions options = AgoraPipOptions(
      ...
      sourceContentView: 0,
      contentView:
          0, // force to use native view // _isUseFlutterTexture ? 0 : viewId,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Second row: Content size + Setup PIP + Start PIP + Stop PIP + Dispose PIP
                    Row(
                      children: [
                        // Content Width
                        Expanded(
                        ...
                        ElevatedButton(
                          ...
                          child: Text(_isInPipMode ? 'Stop' : 'Start'),
                        ),
                        const SizedBox(width: 8),
                        ElevatedButton(
