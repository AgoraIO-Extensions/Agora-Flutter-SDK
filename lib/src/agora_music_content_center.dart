...
class MusicContentCenterEventHandler {
  ...
  /// Callback for music resource details.
  ///
  /// Triggered by SDK when getSongSimpleInfo is called to get details of a music resource.
  ///
  /// * [reason] Request status code of Music Content Center, see MusicContentCenterStateReason.
  /// * [requestId] The request ID. Unique identifier for this request.
  /// * [songCode] The code of the music, which is an unique identifier of the music.
  /// * [simpleInfo] Information about the music resource, including:
  ///  Start and end time of chorus segment (ms)
  ///  Download URL for chorus segment lyrics
  ///  Duration of chorus segment (ms)
  ///  Song title
  ///  Artist name
