...
AudioEncodedFrameObserverOnRecordAudioEncodedFrameJson paramJson = AudioEncodedFrameObserverOnRecordAudioEncodedFrameJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
Uint8List? frameBuffer = paramJson.frameBuffer;
int? length = paramJson.length;
EncodedAudioFrameInfo? audioEncodedFrameInfo = paramJson.audioEncodedFrameInfo;
  if (frameBuffer == null||length == null||audioEncodedFrameInfo == null) { return true; }
  audioEncodedFrameInfo = audioEncodedFrameInfo.fillBuffers(buffers);
  audioEncodedFrameObserver.onRecordAudioEncodedFrame!(frameBuffer,length,audioEncodedFrameInfo);
  return true;
...
final jsonMap = jsonDecode(eventData);
AudioEncodedFrameObserverOnPlaybackAudioEncodedFrameJson paramJson = AudioEncodedFrameObserverOnPlaybackAudioEncodedFrameJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
Uint8List? frameBuffer = paramJson.frameBuffer;
int? length = paramJson.length;
EncodedAudioFrameInfo? audioEncodedFrameInfo = paramJson.audioEncodedFrameInfo;
  if (frameBuffer == null||length == null||audioEncodedFrameInfo == null) { return true; }
  audioEncodedFrameInfo = audioEncodedFrameInfo.fillBuffers(buffers);
  audioEncodedFrameObserver.onPlaybackAudioEncodedFrame!(frameBuffer,length,audioEncodedFrameInfo);
  return true;
...
final jsonMap = jsonDecode(eventData);
AudioEncodedFrameObserverOnMixedAudioEncodedFrameJson paramJson = AudioEncodedFrameObserverOnMixedAudioEncodedFrameJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
Uint8List? frameBuffer = paramJson.frameBuffer;
int? length = paramJson.length;
EncodedAudioFrameInfo? audioEncodedFrameInfo = paramJson.audioEncodedFrameInfo;
  if (frameBuffer == null||length == null||audioEncodedFrameInfo == null) { return true; }
  audioEncodedFrameInfo = audioEncodedFrameInfo.fillBuffers(buffers);
  audioEncodedFrameObserver.onMixedAudioEncodedFrame!(frameBuffer,length,audioEncodedFrameInfo);
  return true;
