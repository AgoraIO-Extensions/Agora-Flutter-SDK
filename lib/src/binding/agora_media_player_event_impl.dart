...
const MediaPlayerVideoFrameObserverWrapper(this.mediaPlayerVideoFrameObserver);
...
MediaPlayerVideoFrameObserverOnFrameJson paramJson = MediaPlayerVideoFrameObserverOnFrameJson.fromJson(jsonMap);
...
bool handleEvent(String eventName, String eventData, List<Uint8List> buffers) {
    ...
    final newEvent = eventName.replaceFirst('MediaPlayerVideoFrameObserver_', '');
