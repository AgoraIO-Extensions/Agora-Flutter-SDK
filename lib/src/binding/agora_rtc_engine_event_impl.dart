...
case 'onJoinChannelSuccess_263e4cdEx':
...
case 'onRejoinChannelSuccess_263e4cdEx':
...
case 'onAudioVolumeIndication_781482aEx':
...
case 'onNetworkQuality_34d8b3cEx':
...
case 'onIntraRequestReceived_c81e1a4Ex':
...
case 'onFirstRemoteVideoDecoded_a68170aEx':
...
case 'onVideoSizeChanged_99bf45cEx':
...
final jsonMap = jsonDecode(eventData);
RtcEngineEventHandlerOnLocalVideoEventJson paramJson = RtcEngineEventHandlerOnLocalVideoEventJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
VideoSourceType? source = paramJson.source;
LocalVideoEventType? event = paramJson.event;
  if (source == null||event == null) { return true; }
...
case 'onRemoteVideoStateChanged_a14e9d1Ex':
...
case 'onFirstRemoteVideoFrame_a68170aEx':
...
case 'onUserMuteAudio_0aac2feEx':
...
case 'onUserMuteVideo_0aac2feEx':
...
case 'onUserEnableVideo_0aac2feEx':
...
case 'onUserStateChanged_65f95a7Ex':
...
case 'onUserEnableLocalVideo_0aac2feEx':
...
case 'onRemoteAudioStats_ffbde06Ex':
...
case 'onLocalAudioStats_5657f05Ex':
...
case 'onRemoteVideoStats_2f43a70Ex':
...
case 'onConnectionLost_c81e1a4Ex':
...
case 'onConnectionInterrupted_c81e1a4Ex':
...
case 'onConnectionBanned_c81e1a4Ex':
...
case 'onStreamMessage_99898cbEx':
...
case 'onStreamMessageError_fe302fcEx':
...
case 'onTokenPrivilegeWillExpire_8225ea3Ex':
...
case 'onLicenseValidationFailure_5dfd95eEx':
...
case 'onFirstLocalAudioFramePublished_263e4cdEx':
...
case 'onFirstRemoteAudioDecoded_c5499bdEx':
...
case 'onFirstRemoteAudioFrame_c5499bdEx':
...
case 'onLocalAudioStateChanged_13b6c02Ex':
...
case 'onRemoteAudioStateChanged_056772eEx':
...
case 'onActiveSpeaker_dd67adcEx':
...
case 'onSnapshotTaken_5a6a693Ex':
...
case 'onClientRoleChanged_2acaf10Ex':
...
case 'onClientRoleChangeFailed_5a3af5bEx':
...
case 'onRemoteAudioTransportStats_527a345Ex':
...
case 'onRemoteVideoTransportStats_527a345Ex':
...
case 'onConnectionStateChanged_4075a9cEx':
...
case 'onNetworkTypeChanged_388fd6fEx':
...
case 'onEncryptionError_e7a65feEx':
...
case 'onUserAccountUpdated_de1c015Ex':
...
case 'onVideoRenderingTracingResult_813c0f4Ex':
...
case 'onUploadLogResult_3115804Ex':
...
case 'onTranscodedStreamLayoutInfo_48f6419Ex':
...
case 'onAudioMetadataReceived_0d4eb96Ex':
if (rtcEngineEventHandler.onAudioMetadataReceived == null) {
    return true;
}
final jsonMap = jsonDecode(eventData);
RtcEngineEventHandlerOnAudioMetadataReceivedJson paramJson = RtcEngineEventHandlerOnAudioMetadataReceivedJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
RtcConnection? connection = paramJson.connection;
int? uid = paramJson.uid;
String? metadata = paramJson.metadata;
int? length = paramJson.length;
  if (connection == null||uid == null||metadata == null||length == null) { return true; }
  connection = connection.fillBuffers(buffers);
  rtcEngineEventHandler.onAudioMetadataReceived!(connection,uid,metadata,length);
  return true;
...
final jsonMap = jsonDecode(eventData);
RtcEngineEventHandlerOnExtensionEventWithContextJson paramJson = RtcEngineEventHandlerOnExtensionEventWithContextJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
ExtensionContext? context = paramJson.context;
String? key = paramJson.key;
String? value = paramJson.value;
  if (context == null||key == null||value == null) { return true; }
...
final jsonMap = jsonDecode(eventData);
RtcEngineEventHandlerOnExtensionStartedWithContextJson paramJson = RtcEngineEventHandlerOnExtensionStartedWithContextJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
ExtensionContext? context = paramJson.context;
...
final jsonMap = jsonDecode(eventData);
RtcEngineEventHandlerOnExtensionStoppedWithContextJson paramJson = RtcEngineEventHandlerOnExtensionStoppedWithContextJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
ExtensionContext? context = paramJson.context;
  if (context == null) { return true; }
  context = context.fillBuffers(buffers);
...
final jsonMap = jsonDecode(eventData);
RtcEngineEventHandlerOnExtensionErrorWithContextJson paramJson = RtcEngineEventHandlerOnExtensionErrorWithContextJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
ExtensionContext? context = paramJson.context;
int? error = paramJson.error;
String? message = paramJson.message;
  if (context == null||error == null||message == null) { return true; }
  context = context.fillBuffers(buffers);
  rtcEngineEventHandler.onExtensionErrorWithContext!(context,error,message);
  return true;


case 'onSetRtmFlagResult_263e4cdEx':
...
case 'onMultipathStats_bc711cfEx':
if (rtcEngineEventHandler.onMultipathStats == null) {
    return true;
}
final jsonMap = jsonDecode(eventData);
RtcEngineEventHandlerOnMultipathStatsJson paramJson = RtcEngineEventHandlerOnMultipathStatsJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
RtcConnection? connection = paramJson.connection;
