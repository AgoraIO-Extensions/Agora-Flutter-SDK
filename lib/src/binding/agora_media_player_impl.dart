...
// final apiType = '${isOverrideClassName ? className : 'MediaPlayer'}_() const';
...
// }
  ...
  Future<void> setAudioPlaybackDelay(int delayMs) async {
    final apiType =
        '${isOverrideClassName ? className : 'MediaPlayer'}_setAudioPlaybackDelay';
    final param = createParams({'delay_ms': delayMs});
    final callApiResult = await irisMethodChannel.invokeMethod(
        IrisMethodCall(apiType, jsonEncode(param), buffers: null));
    if (callApiResult.irisReturnCode < 0) {
      throw AgoraRtcException(code: callApiResult.irisReturnCode);
