  ...
  bool handleEventInternal(
    ...
    switch (eventName) {
      case 'onCaptureVideoFrame':
        ...
        paramJson = paramJson.fillBuffers(buffers);
        VideoSourceType? type = paramJson.type;
        VideoFrame? videoFrame = paramJson.videoFrame;
        if (type == null || videoFrame == null) {
          return true;
        }
        videoFrame = videoFrame.fillBuffers(buffers);
        videoFrameObserver.onCaptureVideoFrame!(type, videoFrame);
        return true;
      ...
      case 'onPreEncodeVideoFrame':
        ...
        videoFrame = videoFrame.fillBuffers(buffers);
        videoFrameObserver.onPreEncodeVideoFrame!(type, videoFrame);
        return true;
