...
MediaPlayerSourceObserverOnPlayerSourceStateChangedJson paramJson = MediaPlayerSourceObserverOnPlayerSourceStateChangedJson.fromJson(jsonMap);
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnPositionChangedJson paramJson = MediaPlayerSourceObserverOnPositionChangedJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
int? positionMs = paramJson.positionMs;
int? timestampMs = paramJson.timestampMs;
  if (positionMs == null||timestampMs == null) { return true; }
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnPlayerEventJson paramJson = MediaPlayerSourceObserverOnPlayerEventJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
MediaPlayerEvent? eventCode = paramJson.eventCode;
int? elapsedTime = paramJson.elapsedTime;
String? message = paramJson.message;
  if (eventCode == null||elapsedTime == null||message == null) { return true; }
  
  mediaPlayerSourceObserver.onPlayerEvent!(eventCode,elapsedTime,message);
  return true;
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnMetaDataJson paramJson = MediaPlayerSourceObserverOnMetaDataJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
Uint8List? data = paramJson.data;
int? length = paramJson.length;
  if (data == null||length == null) { return true; }
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnPlayBufferUpdatedJson paramJson = MediaPlayerSourceObserverOnPlayBufferUpdatedJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
int? playCachedBuffer = paramJson.playCachedBuffer;
  if (playCachedBuffer == null) { return true; }
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnPreloadEventJson paramJson = MediaPlayerSourceObserverOnPreloadEventJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
String? src = paramJson.src;
PlayerPreloadEvent? event = paramJson.event;
  if (src == null||event == null) { return true; }
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnCompletedJson paramJson = MediaPlayerSourceObserverOnCompletedJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnAgoraCDNTokenWillExpireJson paramJson = MediaPlayerSourceObserverOnAgoraCDNTokenWillExpireJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnPlayerSrcInfoChangedJson paramJson = MediaPlayerSourceObserverOnPlayerSrcInfoChangedJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnPlayerInfoUpdatedJson paramJson = MediaPlayerSourceObserverOnPlayerInfoUpdatedJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnPlayerCacheStatsJson paramJson = MediaPlayerSourceObserverOnPlayerCacheStatsJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnPlayerPlaybackStatsJson paramJson = MediaPlayerSourceObserverOnPlayerPlaybackStatsJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
...
final jsonMap = jsonDecode(eventData);
MediaPlayerSourceObserverOnAudioVolumeIndicationJson paramJson = MediaPlayerSourceObserverOnAudioVolumeIndicationJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
