...
H265TranscoderObserverOnEnableTranscodeJson paramJson = H265TranscoderObserverOnEnableTranscodeJson.fromJson(jsonMap);
...
final jsonMap = jsonDecode(eventData);
H265TranscoderObserverOnQueryChannelJson paramJson = H265TranscoderObserverOnQueryChannelJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
H265TranscodeResult? result = paramJson.result;
String? originChannel = paramJson.originChannel;
String? transcodeChannel = paramJson.transcodeChannel;
  if (result == null||originChannel == null||transcodeChannel == null) { return true; }
  
  h265TranscoderObserver.onQueryChannel!(result,originChannel,transcodeChannel);
  return true;
...
final jsonMap = jsonDecode(eventData);
H265TranscoderObserverOnTriggerTranscodeJson paramJson = H265TranscoderObserverOnTriggerTranscodeJson.fromJson(jsonMap);
paramJson = paramJson.fillBuffers(buffers);
H265TranscodeResult? result = paramJson.result;
  if (result == null) { return true; }
