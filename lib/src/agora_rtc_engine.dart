...
abstract class RtcEngine {
  ...
  ///
  /// This method is for Android and iOS only.
  ///  Call this method after enableVideo. The setting takes effect after calling startPreview or joinChannel.
  ///
  ...
  ///
  /// Call this method after enableVideo. The setting takes effect after calling startPreview or joinChannel. After a successful method call, the SDK triggers the onCameraFocusAreaChanged callback. This method is for Android and iOS only.
  ///
  ...
  ///
  /// Call this method after enableVideo. The setting takes effect after calling startPreview or joinChannel. After a successful method call, the SDK triggers the onCameraExposureAreaChanged callback. This method is for Android and iOS only.
  ///
  ...
  ///
  /// This method applies to Windows only. Call this method after enableVideo. The setting takes effect after calling startPreview or joinChannel. When the video capture device does not have the gravity sensing function, you can call this method to manually adjust the rotation angle of the captured video.
  ///
  ...
  ///
  /// After a successful method call of registerMediaMetadataObserver, the SDK triggers the callback, and then you can call this method to send media metadata. If the metadata is sent successfully, the SDK triggers the onMetadataReceived callback on the receiver.
  ///
