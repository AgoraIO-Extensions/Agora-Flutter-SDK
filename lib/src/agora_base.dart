...
enum WarnCodeType {
  ...
  /// @nodoc
  @JsonValue(1060)
  warnAdmRegPhoneListennerFailed,
...
class RtcStats {
  ...
  /// @nodoc
  @JsonKey(name: 'playoutDeviceGlitch')
  final int? playoutDeviceGlitch;
...
class AudioEncodedFrameObserver {
  ...
  const AudioEncodedFrameObserver({
    ...
    this.onPublishAudioEncodedFrame,
  });
  ...
  /// @nodoc
  final void Function(Uint8List frameBuffer, int length,
      EncodedAudioFrameInfo audioEncodedFrameInfo)? onPublishAudioEncodedFrame;
}
