...
class AudioFrameObserverBase {
  ...
  /// To ensure that the format of the collected audio data is as expected, you can choose one of the following two methods to set the audio data format:Method 1: After calling setRecordingAudioFrameParameters to set the audio data format, call registerAudioFrameObserver to register the audio observer object, the SDK calculates the sampling interval according to the parameters in this method, and triggers the onRecordAudioFrame callback according to the sampling interval.Method 2: After calling registerAudioFrameObserver to register audio observer object, set the specific audio observation position in the return value of the callback, and then set the audio data format in the return value of the callback. The SDK calculates the sampling interval according to the return value of the callback, and triggers the onRecordAudioFrame callback according to the sampling interval.The priority of method 1 is higher than that of method 2. If method 1 is used to set the audio data format, the setting of method 2 is invalid.Due to the limitations of Flutter, this callback does not support sending processed audio data back to the SDK.
  ///
  ...
  /// To ensure that the data format of the audio played is as expected, you can choose one of the following two methods to set the audio data format:Method 1: After calling setPlaybackAudioFrameParameters to set the audio data format, call registerAudioFrameObserver to register the audio observer object, the SDK calculates the sampling interval according to the parameters in this method, and triggers the onPlaybackAudioFrame callback according to the sampling interval.Method 2: After calling registerAudioFrameObserver to register audio observer object, set the specific audio observation position in the return value of the callback, and then set the audio data format in the return value of the callback. The SDK calculates the sampling interval according to the return value of the callback, and triggers the onPlaybackAudioFrame callback according to the sampling interval.The priority of method 1 is higher than that of method 2. If method 1 is used to set the audio data format, the setting of method 2 is invalid.Due to the limitations of Flutter, this callback does not support sending processed audio data back to the SDK.
  ///
  /// * [audioFrame] The raw audio data. See AudioFrame .
  /// * [channelId] The channel ID.
  ///
  ...
  /// To ensure that the data format of the audio mixed is as expected, you can choose one of the following two methods to set the audio data format:Method 1: After calling setMixedAudioFrameParameters to set the audio data format, call registerAudioFrameObserver to register the audio observer object, the SDK calculates the sampling interval according to the parameters in this method, and triggers the onMixedAudioFrame callback according to the sampling interval.Method 2: After calling registerAudioFrameObserver to register audio observer object, set the specific audio observation position in the return value of the callback, and then set the audio data format in the return value of the callback. The SDK calculates the sampling interval according to the return value of the callback, and triggers the onMixedAudioFrame callback according to the sampling interval.The priority of method 1 is higher than that of method 2. If method 1 is used to set the audio data format, the setting of method 2 is invalid.Due to the limitations of Flutter, this callback does not support sending processed audio data back to the SDK.
  ///
  /// * [audioFrame] The raw audio data. See AudioFrame .
  /// * [channelId] The channel ID.
  ///
