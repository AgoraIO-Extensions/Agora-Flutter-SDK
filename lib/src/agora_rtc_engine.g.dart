...
Map<String, dynamic> _$ChannelMediaOptionsToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.enableMultipath case final value?) 'enableMultipath': value,
      if (_$MultipathModeEnumMap[instance.uplinkMultipathMode]
          case final value?)
        'uplinkMultipathMode': value,
      if (_$MultipathModeEnumMap[instance.downlinkMultipathMode]
          case final value?)
        'downlinkMultipathMode': value,
      if (_$MultipathTypeEnumMap[instance.preferMultipathType]
          case final value?)
        'preferMultipathType': value,
    };
...
Map<String, dynamic> _$LeaveChannelOptionsToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.unloadAllEffect case final value?) 'unloadAllEffect': value,
