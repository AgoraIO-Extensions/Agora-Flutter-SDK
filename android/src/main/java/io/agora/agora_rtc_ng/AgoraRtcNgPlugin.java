...
public class AgoraRtcNgPlugin
    ...
    onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        videoViewController =
                new VideoViewController(flutterPluginBinding.getTextureRegistry(),
                        flutterPluginBinding.getBinaryMessenger());

        flutterPluginBinding.getPlatformViewRegistry().registerViewFactory(
                "AgoraTextureView",
                new AgoraPlatformViewFactory(
                        "AgoraTextureView", flutterPluginBinding.getBinaryMessenger(),
        ...
        flutterPluginBinding.getPlatformViewRegistry().registerViewFactory(
                "AgoraSurfaceView",
                new AgoraPlatformViewFactory(
                        "AgoraSurfaceView", flutterPluginBinding.getBinaryMessenger(),
    ...
    public void onMethodCall(@NonNull MethodCall call,
        ...
        if ("getAssetAbsolutePath".equals(call.method)) {
            ...
            // dart ffi DynamicLibrary.open do not trigger JNI_OnLoad in iris, so we
            // need call java System.loadLibrary here to trigger the JNI_OnLoad
            // explicitly.
    ...
    private void getAssetAbsolutePath(MethodCall call,
        ...
        if (path != null) {
            if (this.flutterPluginBindingRef.get() != null) {
                ...
                try {
                    this.flutterPluginBindingRef.get()
        ...
        result.error("IllegalArgumentException", "The parameter should not be null",
                null);
    }
