...
//    val canvas = VideoCanvas(null, canvas.renderMode, canvas.channelId, canvas.uid, canvas.mirrorMode)
    val canvas = VideoCanvas(null, canvas.renderMode, canvas.channelId, canvas.uid)
    if (canvas.uid == 0) {
