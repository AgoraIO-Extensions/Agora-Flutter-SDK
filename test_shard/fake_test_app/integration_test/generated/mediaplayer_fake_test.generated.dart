...
//  skip: !(),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      try {
        String key = "hello";
        await mediaPlayerController.getPlayerOption(
          key,
        );
      } catch (e) {
        if (e is! AgoraRtcException) {
          debugPrint('[MediaPlayer.getPlayerOption] error: ${e.toString()}');
          rethrow;
        }
...
//  skip: !(),
  ...
  testWidgets(
    'MediaPlayer.getPlayerOptionInInt',
    (WidgetTester tester) async {
      String engineAppId = const String.fromEnvironment('TEST_APP_ID',
          defaultValue: '<YOUR_APP_ID>');
      ...
      try {
        String key = "hello";
        await mediaPlayerController.getPlayerOptionInInt(
          key,
        );
      } catch (e) {
        if (e is! AgoraRtcException) {
          debugPrint(
              '[MediaPlayer.getPlayerOptionInInt] error: ${e.toString()}');
          rethrow;
        }
...
//  skip: !(),
  ...
  testWidgets(
    'MediaPlayer.getPlayerOptionInString',
    (WidgetTester tester) async {
      String engineAppId = const String.fromEnvironment('TEST_APP_ID',
          defaultValue: '<YOUR_APP_ID>');
      ...
      try {
        String key = "hello";
        await mediaPlayerController.getPlayerOptionInString(
          key,
        );
      } catch (e) {
        if (e is! AgoraRtcException) {
          debugPrint(
              '[MediaPlayer.getPlayerOptionInString] error: ${e.toString()}');
          rethrow;
        }
