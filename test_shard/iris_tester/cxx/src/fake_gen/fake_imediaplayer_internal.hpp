...
#ifndef FAKE_IMEDIAPLAYER_INTERNAL_H_
#define FAKE_IMEDIAPLAYER_INTERNAL_H_

#include "IAgoraMediaPlayer.h"

namespace agora {
namespace rtc {
class FakeIMediaPlayerInternal : public agora::rtc::IMediaPlayer {
...
#endif // FAKE_IMEDIAPLAYER_INTERNAL_H_
