...
class RtcEngineManager: NSObject, RtcEngineInterface {
    ...
    @objc func setAudioSessionOperationRestriction(_: NSDictionary, _: Callback) {
//        callback.resolve(engine) {
...
//        }
    ...
    @objc func setDefaultAudioRoutetoSpeakerphone(_: NSDictionary, _: Callback) {
//        callback.code(engine?.setDefaultAudioRouteToSpeakerphone(params["defaultToSpeaker"] as! Bool))
    }

    @objc func setEnableSpeakerphone(_: NSDictionary, _: Callback) {
//        callback.code(engine?.setEnableSpeakerphone(params["enabled"] as! Bool))
    }

    @objc func isSpeakerphoneEnabled(_: Callback) {
//        callback.resolve(engine) {
//            $0.isSpeakerphoneEnabled()
//        }
    }

    @objc func enableInEarMonitoring(_: NSDictionary, _: Callback) {
//        callback.code(engine?.enable(inEarMonitoring: params["enabled"] as! Bool))
    }

    @objc func setInEarMonitoringVolume(_: NSDictionary, _: Callback) {
//        callback.code(engine?.setInEarMonitoringVolume((params["volume"] as! NSNumber).intValue))
    ...
    @objc func switchCamera(_: Callback) {
//        callback.code(engine?.switchCamera())
    }

    @objc func isCameraZoomSupported(_: Callback) {
//        callback.resolve(engine) {
//            $0.isCameraZoomSupported()
//        }
    }

    @objc func isCameraTorchSupported(_: Callback) {
//        callback.resolve(engine) {
...
//        }
    ...
    @objc func isCameraExposurePositionSupported(_: Callback) {
//        callback.resolve(engine) {
//            $0.isCameraExposurePositionSupported()
//        }
    }

    @objc func isCameraAutoFocusFaceModeSupported(_: Callback) {
//        callback.resolve(engine) {
//            $0.isCameraAutoFocusFaceModeSupported()
//        }
    }

    @objc func setCameraZoomFactor(_: NSDictionary, _: Callback) {
//        callback.resolve(engine) {
...
//        }
    ...
    @objc func setCameraFocusPositionInPreview(_: NSDictionary, _: Callback) {
//        callback.resolve(engine) {
...
//        }
    ...
    @objc func setCameraExposurePosition(_: NSDictionary, _: Callback) {
//        callback.resolve(engine) {
...
//        }
    ...
    @objc func setCameraTorchOn(_: NSDictionary, _: Callback) {
//        callback.resolve(engine) {
...
//        }
    ...
    @objc func setCameraAutoFocusFaceModeEnabled(_: NSDictionary, _: Callback) {
//        callback.resolve(engine) {
...
//        }
    ...
    @objc func enableRemoteSuperResolution(_: NSDictionary, _: Callback) {
