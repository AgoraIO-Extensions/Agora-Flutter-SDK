...
rm -rf $AGORA_FLUTTER_PROJECT_PATH/test_shard/fake_test_app/linux/flutter/ephemeral
...
rm -rf $AGORA_FLUTTER_PROJECT_PATH/test_shard/integration_test_app/linux/flutter/ephemeral
...
rm -rf $AGORA_FLUTTER_PROJECT_PATH/test_shard/rendering_test/linux/flutter/ephemeral
