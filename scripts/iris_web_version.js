...
const irisWebUrl = 'https://download.agora.io/staging/iris-web-rtc_0.1.2-dev.3.js';
const irisWebFakeUrl = 'https://download.agora.io/staging/iris-web-rtc-fake_0.1.2-dev.3.js';
